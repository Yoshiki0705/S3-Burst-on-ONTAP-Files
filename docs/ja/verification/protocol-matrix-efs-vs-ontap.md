...
| プロトコル | D: Amazon EFS | E: FSx for ONTAP |
|---|---|---|
| SMB (2.0 / 3.0 / 3.1.1) | **非対応** | **対応**（全世代） |
| NFSv3 | **非対応** | **対応** |
| NFSv4.0 | **対応**（NFSv4.1 が推奨） | **対応** |
| NFSv4.1 | **対応** | **対応** |
| NFSv4.2 | **非対応** | **対応** |
| `nconnect` マウントオプション | **非対応** | **対応**（最大 16 接続） |
...
| E の SMB / NFSv3 / NFSv4.2 のスループットとレイテンシ | 未測定 |
