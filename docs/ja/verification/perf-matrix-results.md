...
**残るのは「増幅率がデプロイごとに 0.8 と 1.5 に分かれる理由」である。** 同じテンプレート・
同じ指定値・同じワークロードで分かれている。**そこは未確認である。**
...
- **増幅率がデプロイごとに 0.8 と 1.5 に分かれる理由。** 同じテンプレート・同じ指定値・
  同じワークロードで分かれる。**131k と 203k のどちらに出るかはこれで決まる**
